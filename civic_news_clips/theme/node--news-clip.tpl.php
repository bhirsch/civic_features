 ...
 */
?>
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix organization-type-<?php print $organization_type; ?>"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    <?php
      ...
      hide($content['links']);
      // Hide news organization and headline. These are handled
      // seperately because the headline is the node title,
      // which doesn't respect field weights.
